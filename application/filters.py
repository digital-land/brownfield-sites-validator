def healthcheck(validation_dict):
    ...
    if (
        not validation_dict.get("errors")
        and not validation_dict.get("warnings")
        and not validation_dict.get("file_warnings")
        and not validation_dict.get("file_errors")
    ):
        return "Good"
    if (
        not validation_dict.get("errors")
        and validation_dict.get("file_warnings")
        or validation_dict.get("file_errors")
        or validation_dict.get("warnings")
    ):
